...
export interface Env {
  ...
  CORPUS_MANAGEMENT_WRITE_ENABLED?: string;
  SENSE_MANAGEMENT_WRITE_ENABLED?: string;
  TRASH_SWEEP_ENABLED?: string;
  LIBRARY_MANAGEMENT_WRITE_ENABLED?: string;
  DESIGN_MANAGEMENT_WRITE_ENABLED?: string;
