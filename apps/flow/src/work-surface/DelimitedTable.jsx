...
export function DelimitedTable({data}){
 ...
 return <div className="ws-delimited">
  <div className="ws-delimited-options"><Button type="button" color="primary" variant="outline" pill={false} size="sm" aria-pressed={header} onClick={()=>setHeader(value=>!value)}>첫 행을 머리글로</Button></div>
